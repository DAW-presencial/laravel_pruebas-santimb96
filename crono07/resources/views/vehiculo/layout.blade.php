...
<div>
    ...
    <!--<img src="{{ URL::asset('/assets/marvel.png') }}" alt="marvel" style="width: 100px; height: 100px;"/>-->
        <h1 class="text-center m-4">VEHICULOS</h1>
    </div>

    @if( $_SERVER['REQUEST_URI'] !== "/vehiculo" )
        <button class="btn btn-primary m-2" onclick="location.href = '{{ route('vehiculo.index') }}'">Home</button>
    @endif
