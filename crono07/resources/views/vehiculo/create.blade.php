...
@section('contenido')
    ...
    <div class="container d-flex justify-content-center align-items-center">
        <form class="m-4 text-center" action="{{ route('vehiculo.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label">@lang('MODELO')
                    <input class="form-control" type="text" id="modelo" name="modelo" value="{{ old('modelo') }}" />
                </label>
            </div>
            ...
            <div class="mb-3">
                <label class="form-label">@lang('KM')
                    <input class="form-control" type="number" id="km" name="km" value="{{ old('km') }}" />
                </label>
            </div>
